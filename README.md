...
`npm test` takes about two minutes, almost all of it in the traffic-safety acceptance test (every start position across six cities, 51 seeds, 60 seconds of simulation each). Everything else runs in about twelve seconds, so while iterating, skip it:
