...
Curbside Rush is a low-poly, single-player 3D open-world driving game where you run deliveries and passenger fares across four city maps in four countries — each country with its own currency, road rules, and side of the road. Every city is driven after dark, and each one has its own night: New York's cool sodium navy, London's light-polluted violet-grey, Tokyo's mercury-vapour blue and Cairo's warm dust-lit amber, with lit windows, signage and a streetlight every 25-30 m of kerb doing the lighting.

Tokyo's four-lane Sakuragawa Urban Expressway is a useful cross-city route over the river, with five access sites at the west ring, Kanpachi, Chuo-dori, Kawagishi and the east ring.

New York's four-lane Queensview Bridge is a high East River route with four free-flow access sites at E 65th Street, Third Avenue, Vernon Boulevard and 40th Avenue. Its dark cantilever-truss river span and branching approach viaducts are distinct from the smaller at-grade Harborline Bridge, and all eight entrances and exits follow New York's right-hand traffic. Dense rows of houses, brownstones and corner shops fill the southeast approach around Crescent Street and the 40th Avenue loops, with frontage fitted around the bridge and ramps.

Tokyo's nightscape carries 4,288 luminous sign placements on 1,450 buildings across 99 roads: projecting tenant kanban, directory ladders and storefront fascia build a continuous commercial street wall, while façade posters, broad digital screens and roof screens carry 28 original text-free fictional artworks with Japanese copy except for three bilingual campaigns. Large campaigns stay on procedural commercial buildings; authored and modelled residential-style buildings receive only narrow vertical projecting kanban instead of billboards across their windows. Bright editorial, lifestyle and illustrated art replaces Cairo's dark product-board language; Tokyo uses no advertising poles, pedestals, parapet signs or bridge gantries.

The maps are New York City (Upper West Side to the East River), London (Kensington to the City), Tokyo (Setagaya to the Sakuragawa), and Cairo (the Central Nile). New York's large Manhattan grid runs east past Central Park's transverses into an Upper-East-Side-style avenue district, then crosses the East River on two drivable bridges to a residential Queens-style borough of houses and stop-sign corners with its own low-rise shopping street on Steinway Avenue — and a freight railroad running the length of the borough behind the houses, its gated crossings dropping barriers across every avenue when a diesel comes through (Manhattan itself stays rail-free, as it has since 1941) — matched by Cairo's equally broad but deliberately non-grid river city, and the densest of the four: Tahrir and Garden City's winding streets connect across Qasr El-Nil and Al-Galaa bridges to Gezira, Zamalek, and the west bank, and between the corridors a web of twenty-four real one-way harat — single-lane alleys wide enough for exactly one car, every one carrying a real street name from the OSM extract — threads block interiors packed solid with buildings: the floodlit golden belle-époque downtown with its dark-windowed stone, neon-crowned Corniche towers wearing Arabic bank and hotel signs, more than six hundred glossy Arabic-majority pole banners spread across twenty-seven surface corridors—including both Nile bridges—sixty-nine huge fictional image-and-copy skyline boards, thirty-four parapet-mounted signs along the full Sixth of October overpass, and ten approach-facing bridge gantries—including eight across that main deck; everywhere else is the red-brick-and-concrete-skeleton informal city with its satellite dishes, water tanks, shuttered windows and sparse warm-and-fluorescent lit rooms — Bulaq's own mosque standing down one of those alleys with its minaret ringed in green neon, the way every Egyptian mosque marks itself at night; do-not-enter signs guard every hara mouth, the Nile lies black under the bridges with Cairo Tower and river traffic defining the view — plus a mainline railway across the whole north band, its freight trains crossing both Nile channels on a pair of Imbaba-style girder bridges and dropping crossing barriers on eleven streets, Ramsis Street included. London is the third at that scale and keeps left through all of it: the Thames crosses the whole map with three drivable bridges over it, six roundabouts and a signalled Parliament Square gyratory, the King's Road through Chelsea, Knightsbridge and Piccadilly into Regent Street's quadrant, and a royal park with its own lake that you can actually drive through — Serpentine Road crosses the water on its own bridge on the way from Bayswater to the museums. Its streets are built from modelled buildings: gabled brick terraces from Earls Court through Notting Hill out to Islington, white-stucco squares in Chelsea, shopfront parades on the high streets, steel-blue towers in the City around Bank — behind boulevard lawns where the roads want green, with parked cars half up the kerbs, pedestrian guardrails at the big junctions, a clock tower keeping the scenario's own time, an observation wheel on the south bank, red pillar boxes, telephone kiosks and zebra crossings under Belisha beacons — and, in the London manner, a railway with no level crossings at all: a brick viaduct rises from the south bank past the power station, crosses the Thames on its own girder bridge, and lands a green commuter EMU at an elevated riverside terminus in Chelsea while the streets below thread its arches; the other three in-game maps shade their parks green instead of building them. Tokyo is the fourth: the Sakuragawa runs the length of the map under three drivable bridges — Sakura-ōhashi, Kawanaka-bashi and Tsuki-ōhashi — between Gotokuji's narrow hand-built lanes on the west bank — where the Setagaya Line's green two-car tram works a real timetable out of a little depot shed by the spawn — waiting out each turnaround inside, out of sight — ringing down barriers at ten level crossings on its way across the river to the east bank on its own plate-girder bridge; every city runs exactly one railway like it, the trains are solid, the crossings show on both maps, running a closed crossing is the heftiest fine in the game — and a ground-level rail bridge can be driven across if you dare, its girders all that keep you out of the water — and low-rise residential webs of T-junctions and 30 km/h zone streets, strung with utility poles and — on two named streets — sagging overhead cable, most of those webs now salted with their own konbini corner and a diner, izakaya or bakery too — modelled Japanese houses and apāto walk-ups line eight of those webs and both shotengai streets, and modelled zakkyo towers and manshon mid-rises now line downtown, the ring roads and the riverside and east-bank districts too, not just procedural facades — converging on Sakuragawa Downtown's neon core, where Chūō-dōri and Ekimae-dōri cross at a four-way pedestrian scramble lit by chōchin lanterns, vending-machine glow and vertical shop signage, with the Nakamise Yokochō shotengai's shared-space alley of food stalls running right through the middle of it; the Hikari Tower's lit lattice legs and spire stand over the east bank, visible for blocks through the night fog. Pick a city and drive: dispatch offers you work and you take it or pass on it, deliveries load at a business and drop off across town, passenger fares carry a rider to their destination, earnings and fuel are tracked per country, you refuel at gas stations — buying whatever your money covers when it will not stretch to a full tank — and driving badly in front of a patrol car gets you pulled over — the patrol stops you at the kerb, an officer walks up to your window, and the fine lands there. A third of the traffic lights watch themselves: run one of those reds, or speed past one, and the ticket arrives with no one there to hand it to you. Every street posts a speed limit, on signs you can read from the road and on the HUD, in whatever that country signs in. Crashes wear the car down, and what putting it right costs depends on how badly: drive into a repair shop's bay and you pay for the damage you are carrying, while wrecking it outright means a tow that bills for the lot at a premium. A corner minimap scrolls under you with a GPS line to the next stop and turn-by-turn directions above it; press **M** for the whole city, including fuel, repairs, venues and traffic-light cameras. Also included are first- and third-person cameras with rear-view and wing mirrors, keyboard/mouse/gamepad/touch controls, ambient traffic and pedestrian crowds, local progress, accessibility settings, and official road-rule references.

London's rebuilt street fabric adds thirteen connected streets across Chelsea, the west, Mayfair, Bloomsbury and the South Bank, turning the old superblocks into tighter terrace-lined cells. Kensington Park Road now carries an uninterrupted modelled street wall on both sides; a small lawn can trim only the frontage it actually touches, never erase a whole road. Deep one-sided parcels grow road-aware rear mews, oversized perimeter blocks gain internal terrace courts, and the remaining safe gaps become compact courtyard cells, so a frontage row can no longer hide a concrete field behind it. Both Thames banks now carry continuous green embankment walks with benches, broadleaf trees, black park lamps and open bridge mouths; Chelsea's former patchwork lawns are two formal garden squares with crossing walks, parterres and seating, plus a coherent Battersea greensward.

Every city has its own deterministic kerbside population. Cars face the adjacent legal traffic flow and stay clear of junctions, railways, parks, water, businesses, service forecourts and hand-placed street furniture.
