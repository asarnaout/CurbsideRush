...
export const NATURE_MODELS: readonly NatureModel[] = [
  { id: "tree-broadleaf", url: `${P}/nature-tree-broadleaf.glb`, sets: ["temperate", "civic"], scale: 5.2, role: "tree" },
  { id: "tree-oak", url: `${P}/nature-tree-oak.glb`, sets: ["temperate", "civic"], scale: 7.0, role: "tree" },
  { id: "tree-tall", url: `${P}/nature-tree-tall.glb`, sets: ["temperate", "temple"], scale: 5.5, role: "tree" },
  { id: "tree-small", url: `${P}/nature-tree-small.glb`, sets: ["temperate", "temple"], scale: 5.0, role: "tree" },
  { id: "conifer-tall", url: `${P}/nature-conifer-tall.glb`, sets: ["temperate"], scale: 5.5, role: "conifer" },
  { id: "conifer-round", url: `${P}/nature-conifer-round.glb`, sets: ["temperate", "temple"], scale: 5.0, role: "conifer" },
  { id: "palm-tall", url: `${P}/nature-palm-tall.glb`, sets: ["arid"], scale: 6.0, role: "palm" },
  { id: "palm-short", url: `${P}/nature-palm-short.glb`, sets: ["arid"], scale: 5.0, role: "palm" },
  { id: "bush", url: `${P}/nature-bush.glb`, sets: ["temperate", "arid", "temple", "civic"], scale: 4.0, role: "shrub" },
  { id: "bush-large", url: `${P}/nature-bush-large.glb`, sets: ["temperate", "arid", "civic"], scale: 5.5, role: "shrub" },
  // The kit's triangular bushes read as clipped topiary, which is what a
  // temple garden and a formal civic bed both want.
  { id: "bush-clipped", url: `${P}/nature-bush-clipped.glb`, sets: ["temple", "civic"], scale: 4.0, role: "shrub" },
  { id: "flower-red", url: `${P}/nature-flower-red.glb`, sets: ["temperate", "civic"], scale: 2.0, role: "flower" },
  { id: "flower-yellow", url: `${P}/nature-flower-yellow.glb`, sets: ["temperate", "arid", "civic"], scale: 2.0, role: "flower" },
  { id: "grass-tuft", url: `${P}/nature-grass-tuft.glb`, sets: ["temperate", "temple"], scale: 2.0, role: "tuft" },
  { id: "grass-tuft-large", url: `${P}/nature-grass-tuft-large.glb`, sets: ["temperate"], scale: 2.2, role: "tuft" },
  { id: "rock-large", url: `${P}/nature-rock-large.glb`, sets: ["temperate", "arid", "temple"], scale: 3.0, role: "rock" },
  { id: "rock-small", url: `${P}/nature-rock-small.glb`, sets: ["temperate", "arid", "temple"], scale: 2.5, role: "rock" },
