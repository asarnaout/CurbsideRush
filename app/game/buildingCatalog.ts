...
export const CAIRO_ENV_MODELS: readonly EnvModelMeta[] = [
  ...
  // bundled hydrants and Western-style canopies removed after the
  ...
  { id: "cairo-walkup-a", url: `${P}/cairo-walkup-a.glb?rev=shopfront-v3`, category: "brownstone", title: "Building", author: "Kay Lousberg", license: "CC0 1.0", sourceUrl: src("qOhhGLftam") },
  { id: "cairo-walkup-b", url: `${P}/cairo-walkup-b.glb?rev=shopfront-v3`, category: "brownstone", title: "Building", author: "Kay Lousberg", license: "CC0 1.0", sourceUrl: src("T3oyvK6VEU") },

  // ---- Already shipping as gig-venue props; also placed in the street wall so
  // the two the map already had stop being rarities.
  { id: "cairo-residence-kay", url: `${P}/cairo-residence-kay.glb?rev=shopfront-v3`, category: "brownstone", title: "Building", author: "Kay Lousberg", license: "CC0 1.0", sourceUrl: src("otRsYa6pan") },
  ...
  { id: "cairo-shop", url: `${P}/cairo-shop.glb?rev=shopfront-v3`, category: "shop", title: "Building", author: "Kay Lousberg", license: "CC0 1.0", sourceUrl: src("EL3ePInr1N") },
];
